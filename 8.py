...
def show_user_profile(user_data):
    ...
    with tabs[4]:  # Leftovers tab
     st.subheader("♻️ Leftover Management History")
        ...
        for recipe in user_data['leftovers']:
            with st.expander(f"{recipe['date']} - {recipe['name']}"):
                ...
                with col1:
                    ...
                    st.write("**⏲️ Cooking Information:**")
   ...
   # Menu Performance    
    ...
    with col1:
        user_mood = st.selectbox(
            ...
            options=["Very Sad 😢", "Sad 😔", "Neutral 😐", "Happy 😊", "Very Happy 😄", "Emotional", "Excited 😍", "Energetic 💪", "Relaxed 😌", "Tired"]
        )
    ...
    # Replace this section in the Leftover Management part:
